            ...
            <div className="sidebar" data-color="space"> {/* data-color is defined in light-bootstrap-dashboard.css */}
                <div className="sidebar-wrapper">
                    ...
                    <ul className="nav nav-pills nav-stacked">
                        ...
                        { this.state.logged_in === true && <NLink to={`${process.env.PUBLIC_URL}/team`}><p style={{fontWeight: "inherit", textTransform: "none", fontSize: "inherit"}}><i className="pe-7s-users pe-fw" />Team</p></NLink>}
                        ...
                        { this.state.user.is_staff && <NLink to={`${process.env.PUBLIC_URL}/staff`}><p style={{fontWeight: "inherit", textTransform: "none", fontSize: "inherit"}}><i className="pe-7s-tools pe-fw" />Staff</p></NLink> }
