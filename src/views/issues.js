                                ...
                                <p>
                                    ...
                                    <ul>
                                        ...
                                        <ul>
                                            ...
                                            <li>For Windows, try following <a target="_blank" rel="noopener noreferrer" href="https://www.theserverside.com/feature/How-to-set-JAVA_HOME-in-Windows-and-echo-the-result">these instructions</a>.</li>
                                            <li>Try setting <code>org.gradle.java.home=/path_to_jdk_1.8_directory</code>. You need to know your <code>JAVA_HOME</code> (try <a target="_blank" rel="noopener noreferrer" href='https://www.baeldung.com/find-java-home'>this guide</a>).</li>
                                        </ul>
                                        </li>
                                    ...
                                    If your error is not listed above, ask on <a target="_blank" rel="noopener noreferrer" href='https://discordapp.com/channels/386965718572466197/662426611563626537'>the Discord</a>.
                                </p>
                                </div>
                            </div>
                            ...
                            <div className="card">
                                ...
                                <p>
                                    <ul>
                                        ...
                                        <li>Redownload <a target="_blank" rel="noopener noreferrer" href="https://github.com/battlecode/battlecode20-scaffold">the scaffold</a>.</li>
                                    </ul>
                                </p>
                                </div>
                            </div>
