...
class GettingStarted extends Component {
  ...
  getIDEInstallation() {
      if (this.state.ide === 'intellij') {
        ...
        <li>Install IntelliJ IDEA Community Edition <a target="_blank" rel="noopener noreferrer" href='https://www.jetbrains.com/idea/download/'>from here</a>.</li>

        <li>In the <code>Welcome to IntelliJ IDEA</code> window that pops up when you start IntelliJ, select <code>Open or Import</code></li>
        ...
        <li>If you haven't seen any errors, you should be good to go.</li>
          ...
          return (
              <div>
                  <ul style={{marginLeft: '-15px'}}>
<li>Download the latest version of Eclipse <a target="_blank" rel="noopener noreferrer" href='https://www.eclipse.org/downloads/'>from here</a>.</li>
                        ...
                        <div className="col-md-12">
                            <div className="card">
                                ...
                                <p>
                                    ...
                                    for the duration of the contest. For a general overview of what Battlecode is, visit <a target="_blank" rel="noopener noreferrer" href='https://battlecode.org'>
                                        our landing page</a>.

                                </p>
                                <p>
                                    This year's game is a thrilling survival adventure involving <span aria-label="emoji" role='img' >🍲, ▀⛓, 🐮, 🤖</span>, and more. You will write bots in Java.
                                </p>
                                <p>
                                    Battlecode 2020 is released! Read the <a target="_blank" rel="noopener noreferrer" href="specs.html">game specifications</a>. {/* Check out <a href="https://2020.battlecode.org/visualizer.html?https://2020.battlecode.org/replays/7af61a1f891466628921dca098b895.bc20">this example replay</a> for a demo of the game! */}
                                </p>
                                </div>
                            </div>
                            <div className="card">
                            ...
                            <div className="card">
                                ...
                                work. <b><a target="_blank" rel="noopener noreferrer" href="http://www.oracle.com/technetwork/java/javase/downloads/jdk8-downloads-2133151.html" style={{fontWeight:700}}>Download it here</a></b>.
...
If you're unsure how to install the JDK, you can find instructions for all operating systems <a target="_blank" rel="noopener noreferrer" href='https://docs.oracle.com/javase/8/docs/technotes/guides/install/install_overview.html'>here</a> (pay attention to <code>PATH</code> and <code>CLASSPATH</code>).
</p>
<h6 class='installation-steps'>Step 2: Download Battlecode</h6>
<p>

    Next, you should download the <a target="_blank" rel="noopener noreferrer" href="https://github.com/battlecode/battlecode20-scaffold">Battlecode 2020 scaffold</a>.

    To get up and running quickly, you can click "Clone or download" and then "Download ZIP," and move on to the next step.

    </p><p>
    We recommend, however, that you instead use Git to organize your code. If you haven't used Git before, read <a target="_blank" rel="noopener noreferrer" href='https://guides.github.com/introduction/git-handbook/'>this guide</a> (or
    wait for our lecture covering it). On the <a target="_blank" rel="noopener noreferrer" href="https://github.com/battlecode/battlecode20-scaffold">scaffold page</a>, click "Use this template." Importantly, on the next page, make your new repo <b>private</b> (you don't want other teams to steal your code!). You can then clone your newly created repo and invite your team members to collaborate on it.
    </p>
...
If you're on Linux, navigate to the <code>client</code> folder and run <code>./battlecode-visualizer</code> to launch the client.</p>
                            ...
                            <div className="card">
                                ...
                                <div className="content">
                                <p>
                                    Create a zip file containing only your robot code (only 1 package), and uploaded it to the <NavLink to='submissions'>submissions</NavLink> page. (After you create or join a team!)
                                </p>
                                <p>
                            ...
                            <div className="card">
                                ...
                                <div className="content">
                                <p>
                                    Now, read the <a target="_blank" rel="noopener noreferrer" href='specs.html'>game specs</a> carefully and consult the <a target="_blank" rel="noopener noreferrer" href='javadoc/index.html'>javadocs</a> to learn about the API.
                                </p>
                                <p>
                            ...
                            <div className="card">
                                ...
                                <p>
                                    ...
                                    happen on Discord. Follow this invite link to join: <a target="_blank" rel="noopener noreferrer" href='https://discord.gg/N86mxkH'>https://discord.gg/N86mxkH</a>.
                                </p>
