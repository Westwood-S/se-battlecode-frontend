            ...
            return (
                <div className="card">
                    ...
                    <div className="content">
                        ...
                        <p>Your robot player folder is originally located in <code>./battlecode20-scaffold-master/src</code> with name <code>examplefuncsplayer</code></p><p>
                            Your team should give the robot player folder a unique name, for robots with duplicate names are not supported in the server.
                            </p><p>And remember to update the first line of every <code>.java</code> file inside, from <code>package examplefuncsplayer;</code> to <code>package [thenameyouchoose]; </code> </p>
                        <p>
