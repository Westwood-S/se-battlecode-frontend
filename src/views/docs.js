                            ...
                            <div className="card">
                                ...
                                <div className="content">
                                    ...
                                    <p>Each unit has a unique <code>{ SPECS.MAX_ID }</code>-bit integer ID and a vision radius that allows them to see any other unit within a <i>squared</i> radius
                                      ...
                                      <a target="_blank" rel="noopener noreferrer" href="../../assets/img/voyager_vision.png"> Here is a picture</a> showing the visible regions (note that the same is true for <b>Planets</b> as well as for <b>Voyagers</b>).</p>
