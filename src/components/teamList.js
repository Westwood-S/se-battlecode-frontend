                ...
                <div>
                    <div className="card">
                        <div className="header">
                            ...
                            <br/>
                            <div>If you're interested in how the score is calculated, see <a target="_blank" rel="noopener noreferrer" href="https://en.wikipedia.org/wiki/Elo_rating_system#Mathematical_details">here</a></div>
                        </div>
